...
const withAdminLayout = (Component: ComponentType) => {
  return (props: object) => {
    ...
    const [settingsState, setSettingsStateState] = useState(false); // (kept if you use later)
            ...
            <Toolbar>
              ...
              >
                <Box
                  ...
                  sx={{ width: '200px' }}
                >
                  <Stack component="div" sx={{ px: '20px', my: '12px' }}>
          ...
          >
            <Toolbar sx={{ flexDirection: 'column', alignItems: 'flex-start' }}>
              <Stack component="div" className="logo-box">
                <img src="/img/logo/vorell-gold.png" alt="logo" />
              </Stack>
